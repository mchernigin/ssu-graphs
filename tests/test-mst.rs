...
mod tests {
    ...
    fn test_prim1() -> GraphResult<()> {
        let gr = Graph::from_file("graphs/tests/mst1.gr".to_string())?;
    ...
    fn test_prim2() -> GraphResult<()> {
        let gr = Graph::from_file("graphs/tests/mst2.gr".to_string())?;
        let mst = algorithms::mst::prim(&gr)?;
        let mst_weight: i32 = mst.iter().map(|edge| edge.2).sum();
    ...
    fn test_prim3() -> GraphResult<()> {
        let gr = Graph::from_file("graphs/tests/mst3.gr".to_string())?;
        let mst = algorithms::mst::prim(&gr)?;
        let mst_weight: i32 = mst.iter().map(|edge| edge.2).sum();
    ...
    fn test_prim4() -> GraphResult<()> {
        let gr = Graph::from_file("graphs/tests/mst4.gr".to_string())?;
        let mst = algorithms::mst::prim(&gr)?;
        let mst_weight: i32 = mst.iter().map(|edge| edge.2).sum();
